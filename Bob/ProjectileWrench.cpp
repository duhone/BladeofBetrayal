// ProjectileWrench.cpp: implementation of the ProjectileWrench class.
//
//////////////////////////////////////////////////////////////////////
...
ProjectileWrench::ProjectileWrench(bool sDirection, int xPos, int yPos, float xVel, float yVel, float xAcc, float yAcc)
{
	/* Set Sprite Number */
	SetSprite(1, CR::AssetList::Wrench);
...
ProjectileWrench::~ProjectileWrench()
{
}

HPTRect &ProjectileWrench::GetWeaponBounds()
{
